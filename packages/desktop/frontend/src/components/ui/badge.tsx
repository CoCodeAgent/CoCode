...
destructive:
				'bg-destructive-soft text-destructive focus-visible:ring-destructive dark:bg-destructive-soft dark:focus-visible:ring-destructive [a]:hover:bg-destructive-soft',
			glass:
				'border border-border bg-card text-muted-foreground [a]:hover:bg-card [a]:hover:text-foreground',
			outline:
