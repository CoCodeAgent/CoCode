							...
							<div className="flex-1 overflow-y-auto space-y-1">
								...
								{!sessionsLoading &&
									sessions.map((session) => (
										<div
											key={session.id}
											className="flex flex-row justify-between text-xs px-2.5 py-2 font-mono rounded-md ring ring-border items-center cursor-pointer hover:bg-muted transition-colors"
											onClick={() => {
												navigate(
